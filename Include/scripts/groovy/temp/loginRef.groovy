...
/**
 ...
 Mobile.tap(findTestObject('SecurityPage/digitboxSC1'), GlobalVariable.tm)
 Mobile.delay(2)
 ...
 def forgotSCClick(){
 Mobile.tap(findTestObject("SecurityPage/button-forgetSecCode"), GlobalVariable.tm)
 }
 ...
 def wrongClickPass(){
 Mobile.tap(findTestObject('SecurityPage/button-ForgetPassword'), GlobalVariable.tm)
 Mobile.delay(3)
 }
 @When("User re-enter new password and confirm new password in a form")
 def resetPassword(){
 Mobile.tap(findTestObject('SecurityPage/button-right'), GlobalVariable.tm)
 Mobile.delay(3)
 //In Get Started Page
 AD<?> driver = MB.getDriver()
 ...
 def clickBack(){
 Mobile.tap(findTestObject('SecurityPage/button-left'), GlobalVariable.tm)
 Mobile.delay(3)
 }
 ...
 Mobile.delay(2)
 Mobile.tap(findTestObject('SecurityPage/button-close'), GlobalVariable.tm)
 }
 }
 class getStarted {
